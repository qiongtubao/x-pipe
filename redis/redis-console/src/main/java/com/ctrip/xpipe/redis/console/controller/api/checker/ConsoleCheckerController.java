...
public class ConsoleCheckerController extends AbstractConsoleController {
    ...
    public void recordAlert(@RequestBody CheckerConsoleService.AlertMessage alertMessage) {
        this.persistenceCache.recordAlert(alertMessage.getMessage(), alertMessage.getEmailResponse());
    }

//    @RequestMapping(value = "/api/checker/persistence/getMonitorActiveProxies/{dcId}", method = RequestMethod.GET)
//    public List<ProxyEndpoint> getMonitorActiveProxies(@PathVariable String dcId) {
//        return this.persistence.getMonitorActiveProxies(dcId);
//    }
